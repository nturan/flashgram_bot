...
class TestFlashcardGenerator:
    ...
    def test_save_flashcards_to_database_exception(self, mock_service):
        ...
        flashcards = [TwoSidedCard(front="Test", back="Answer", title="Card")]
    ...
    def test_generate_flashcards_from_grammar_noun(self):
        ...
        with patch.object(
            generator.noun_generator, "generate_flashcards_from_grammar"
        ) as mock_gen:
    ...
    def test_generate_flashcards_from_grammar_adjective(self):
        ...
        with patch.object(
            generator.adjective_generator, "generate_flashcards_from_grammar"
        ) as mock_gen:
            mock_gen.return_value = []

            flashcards = generator.generate_flashcards_from_grammar(
    ...
    def test_generate_flashcards_from_grammar_verb(self):
        ...
        with patch.object(
            generator.verb_generator, "generate_flashcards_from_grammar"
        ) as mock_gen:
    ...
    def test_generate_flashcards_from_grammar_pronoun(self):
        ...
        with patch.object(
            generator.pronoun_generator, "generate_flashcards_from_grammar"
        ) as mock_gen:
    ...
    def test_generate_flashcards_from_grammar_number(self):
        ...
        with patch.object(
            generator.number_generator, "generate_flashcards_from_grammar"
        ) as mock_gen:
            mock_gen.return_value = []
    ...
    def test_generate_flashcards_from_grammar_with_sentences(self):
        ...
        mock_noun = Mock(spec=Noun)
        sentences = {
            "nominative_singular": "Это дом.",
            "genitive_singular": "У меня нет дома.",
        }
...
class TestBaseGenerator:
    ...
    def test_create_fill_in_gap_card(
        self, mock_suffix_extractor, mock_text_processor, mock_sentence_generator
    ):
        """Test creating a fill-in-the-gap flashcard."""
        generator = BaseGenerator()

        # Mock the dependencies
        mock_sentence_generator.return_value.generate_example_sentence.return_value = (
            "Я читаю книгу дома."
        )
        mock_suffix_extractor.return_value.extract_suffix.return_value = ("дом", "а")
        mock_text_processor.return_value.create_sentence_with_blank.return_value = (
            "Я читаю книгу дом{blank}."
        )
    ...
    @patch("app.my_graph.generators.base_generator.LLMSentenceGenerator")
    def test_create_fill_in_gap_card_with_pre_generated_sentence(
        self, mock_sentence_generator
    ):
        ...
        with patch.object(generator.suffix_extractor, "extract_suffix") as mock_suffix:
            with patch.object(
                generator.text_processor, "create_sentence_with_blank"
            ) as mock_blank:
    ...
    def test_should_create_flashcard(self):
        ...
        assert (
            generator.should_create_flashcard("ДОМ", "дом") == False
        )  # case insensitive
...
class TestNounGenerator:
    ...
    def test_generate_flashcards_from_grammar_basic(self, mock_logger):
        ...
        mock_noun.plural = {"nominative": "столы", "genitive": "столов"}
        ...
        with patch.object(generator, "_generate_singular_forms") as mock_singular:
            with patch.object(generator, "_generate_plural_forms") as mock_plural:
                with patch.object(
                    generator, "_generate_property_flashcards"
                ) as mock_properties:
        ...
        with patch.object(generator, "_generate_singular_forms") as mock_singular:
            with patch.object(generator, "_generate_plural_forms") as mock_plural:
                with patch.object(
                    ...
                    generator.generate_flashcards_from_grammar(
                        mock_noun, "noun", sentences
                    )
