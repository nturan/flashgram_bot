...
from app.flashcards.models import (
    TwoSidedCard, FillInTheBlank, MultipleChoice, DictionaryWord,
    FlashcardType, DifficultyLevel, WordType,
...
class TestFillInTheBlank:
    ...
    def test_fill_in_blank_get_question(self):
        ...
        card = FillInTheBlank(
            text_with_blanks="The {blank} is {blank}.",
    ...
    def test_fill_in_blank_multiple_blanks(self):
        ...
        card = FillInTheBlank(
            text_with_blanks="I {blank} a {blank} book.",
            answers=["read", "good"]
        )
    ...
    def test_fill_in_blank_get_blank_count(self):
        ...
        card1 = FillInTheBlank(
            text_with_blanks="One {blank}",
            answers=["word"]
        )
        assert card1.get_blank_count() == 1
        
        card2 = FillInTheBlank(
            text_with_blanks="Two {blank} and {blank}",
            answers=["words", "more"]
        )
        assert card2.get_blank_count() == 2
        
        card3 = FillInTheBlank(
            text_with_blanks="No blanks here",
            answers=[]
        )
