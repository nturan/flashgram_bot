...
def create_edit_delete_keyboard(item_id: str, 
                               show_answer: bool = True,
                               additional_buttons: Optional[List[Tuple[str, str]]] = None) -> InlineKeyboardMarkup:
...
def create_confirmation_keyboard(item_id: str, 
                                action: str = "delete",
    ...
    try:
        buttons = [[
            InlineKeyboardButton(confirm_text, callback_data=f"confirm_{action}_{item_id}"),
            InlineKeyboardButton(cancel_text, callback_data=f"cancel_{action}_{item_id}")
        ]]
...
def create_multiple_choice_keyboard(options: List[str], 
                                   item_id: str,
                                   include_controls: bool = True) -> InlineKeyboardMarkup:
