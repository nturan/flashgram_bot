...
class QuestionFormatter:
    ...
    def _format_two_sided_card(self, flashcard: TwoSidedCard) -> Tuple[str, Optional[Any]]:
    ...
    def _format_fill_in_blank_card(self, flashcard: FillInTheBlank) -> Tuple[str, Optional[Any]]:
    ...
    def _format_multiple_choice_card(self, flashcard: MultipleChoice) -> Tuple[str, Optional[Any]]:
        ...
        keyboard = self.keyboard_builder.create_multiple_choice_keyboard_with_controls(flashcard)
        return text, keyboard