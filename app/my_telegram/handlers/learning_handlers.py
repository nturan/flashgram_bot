...
async def learn_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        flashcards = await flashcard_service.get_learning_session_flashcards(user_id, cards_per_session)
...
async def process_answer(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await flashcard_service.update_flashcard_after_review(user_id, current_flashcard, is_correct)
