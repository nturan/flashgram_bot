...
class FormAnalyzer:
    ...
    def get_form_description(
        self, word_type: str, case: str, number: str = None, gender: str = None
    ) -> str:
        ...
        try:
            if word_type == "noun":
                ...
                return self._get_verb_form_description(
                    case
                )  # case is actually tense/person for verbs
            else:
                return f"{case} form"
    ...
    def _get_adjective_form_description(
        self, case: str, number: str, gender: str
    ) -> str:
    ...
    def extract_metadata_from_grammar_obj(
        ...
        try:
            ...
            if word_type == "noun":
                metadata.update(
                    {"gender": grammar_obj.gender, "animacy": grammar_obj.animacy}
                )
            elif word_type == "adjective":
