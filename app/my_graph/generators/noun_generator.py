...
class NounGenerator(BaseGenerator):
    ...
    def generate_flashcards_from_grammar(self, noun: Noun, word_type: str = "noun", generated_sentences: Dict[str, str] = None) -> List[Any]:
        ...
        flashcards.extend(self._generate_singular_forms(noun, dictionary_form, generated_sentences))
        
        # Generate fill-in-the-gap flashcards for plural forms
        flashcards.extend(self._generate_plural_forms(noun, dictionary_form, generated_sentences))
    ...
    def _generate_singular_forms(self, noun: Noun, dictionary_form: str, generated_sentences: Dict[str, str]) -> List[Any]:
    ...
    def _generate_plural_forms(self, noun: Noun, dictionary_form: str, generated_sentences: Dict[str, str]) -> List[Any]:
