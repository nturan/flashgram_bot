...
class VerbGenerator(BaseGenerator):
    ...
    def _generate_imperative_flashcards(
        ...
        # Singular imperative
        if verb.imperative_singular and self.should_create_flashcard(
            verb.imperative_singular, dictionary_form
        ):
        ...
        # Plural imperative
        if verb.imperative_plural and self.should_create_flashcard(
            verb.imperative_plural, dictionary_form
        ):
